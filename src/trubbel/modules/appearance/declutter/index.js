export default class Declutter {
  constructor(parent) {
    ...
    this.CLASSES = {
      ...
      "hide-input-chat-reply": ".chat-input__buttons-container div:has(> div > button[data-a-target=\"chat-send-button\"])",
      ...
      "hide-sidebar-save-streak": ".side-nav div[role=\"group\"]:has(a[class*=\"saveYourStreakSideNavRow\"])",
  ...
  onEnable() {
    ...
    this.toggleHide("hide-input-chat-reply", this.settings.get("addon.trubbel.appearance.declutter.chat.send_reply"));
    ...
    this.toggleHide("hide-sidebar-save-streak", this.settings.get("addon.trubbel.appearance.declutter.sidebar.save_streak"));
